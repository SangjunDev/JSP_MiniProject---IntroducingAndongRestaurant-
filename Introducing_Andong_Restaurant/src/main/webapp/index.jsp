      ...
      <div class="carousel-inner">
            ...
            <div class="container">
               <div class="row p-5">
                  <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                     <img class="img-fluid" src="./assets/img/main01.jpg" alt="">
                  </div>
                  <div class="col-lg-6 mb-0 d-flex align-items-center">
                     <div class="text-align-left align-self-center">
                        <h1 class="h1 text-success">
                           <b>Project</b> AND Yummy
                        </h1>
                        <h3 class="h2">인공지능 1팀 AND</h3>
                        <p></p>
                     </div>
                  </div>
               </div>
         ...
         <div class="carousel-item">
            <div class="container">
               <div class="row p-5">
                  <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                     <img class="img-fluid" src="./assets/img/인공지능-removebg-preview.png"
                        alt="">
                  </div>
                  <div class="col-lg-6 mb-0 d-flex align-items-center">
                     <div class="text-align-left">
                        <h1 class="h1"> 한국품질재단 혁신성장 </h1>
                        <h3 class="h2"> 청년인재 집중양성 </h3>
                        <p>
                           [과정2. 프로젝트 기반의 인공지능 개발자 양성]
                        </p>
                     </div>
                  </div>
               </div>
         ...
         <div class="carousel-item">
            <div class="container">
               <div class="row p-5">
                  <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                     <img class="img-fluid" src="./assets/img/단체사진.jpg"
                        alt="">
                  </div>
                  <div class="col-lg-6 mb-0 d-flex align-items-center">
                     <div class="text-align-left">
                        <h1 class="h1"> AND Yummy </h1>
                        <h3 class="h2"> 인공지능 1팀 AND </h3>
                        <p></p>
                     </div>
                  </div>
   ...
   <section class="container py-5">
      <div class="row text-center pt-3">
         <div class="col-lg-6 m-auto">
            <h1 class="h1">
               Categories of the Andong
            </h1>
                <br>
            <p>Andong University, Andong City, Andong Okdong Restaurant Information</p>
         </div>
      </div>
      <div class="row">
         <div class="col-12 col-md-4 p-5 mt-3">
            <a href="#"><img src="./assets/img/안동대.png"
               class="rounded-circle img-fluid border"></a>
            <h5 class="text-center mt-3 mb-3">안동대</h5>
            <p class="text-center">
               <a href="restaurant/restaurant.jsp" class="btn btn-success">Go</a>
            </p>
         </div>
         <div class="col-12 col-md-4 p-5 mt-3">
            <a href="#"><img src="./assets/img/안동시내.png"
               class="rounded-circle img-fluid border"></a>
            <h5 class="h5 text-center mt-3 mb-3">
               안동시내
               </h2>
               <p class="text-center">
                  <a href="restaurant/restaurant1.jsp" class="btn btn-success">Go</a>
               </p>
         </div>
         <div class="col-12 col-md-4 p-5 mt-3">
            <a href="#"><img src="./assets/img/안동옥동.png"
               class="rounded-circle img-fluid border"></a>
            <h5 class="h5 text-center mt-3 mb-3">
               안동옥동
               </h2>
               <p class="text-center">
                  <a href="restaurant/restaurant2.jsp" class="btn btn-success">Go</a>
               </p>
         </div>
      </div>
   </section>
            ...
            <!-- 
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        ...
                        <li><a class="text-decoration-none" href="#">restaurant Locations</a></li>
